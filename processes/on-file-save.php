...
if (strtolower($fileExt) == "scss" && file_exists(dirname(__FILE__)."/../plugins/scssphp/scss.inc.php")) {
	...
	try {
		...
		echo ";top.ICEcoder.message('Sorry','Couldn\'t compile your Sass, error info below:\\n\\n".$e->getMessage()."','error');";
	}
}
...
if (strtolower($fileExt) == "less" && file_exists(dirname(__FILE__)."/../plugins/lessphp/lessc.inc.php")) {
	...
	try {
		...
		echo ";top.ICEcoder.message('Sorry','Couldn\'t compile your LESS, error info below:\\n\\n".$e->getMessage()."','error');";
	}
}
?>
